...
public	class UploadingSucceed extends JFrame {
    ...
    public UploadingSucceed() {
        ...
        ImageIcon ImBKUploadingSucceed=new ImageIcon(this.getClass().getResource("/UI_view/USucceed.png"));
